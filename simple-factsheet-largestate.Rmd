...
\item Reducing the uninsurance rate among women of reproductive age in `r state_table$statename` may require `r statement5`
\end{itemize}
\switchcolumn
...
Among approximately `r statement7` uninsured women of reproductive age in `r table$statename` in 2017 (figure 2),
