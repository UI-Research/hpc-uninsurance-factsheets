...
table1 <- read.csv(file="D:/Users/LDurbak/Box Sync/My Box Notes/HPC/R Factsheets Uninsurance/hpc-uninsurance-factsheets-master/Tables/StateFactSheetData_521.csv", header=TRUE, sep=",")
datdict <- read.csv(file="D:/Users/LDurbak/Box Sync/My Box Notes/HPC/R Factsheets Uninsurance/hpc-uninsurance-factsheets-master/Tables/State Uninsurance WRA Data Dictionary.csv", header=TRUE, sep=",")
...
p<-ggplot(table2) + 
  ...
  geom_text_repel(mapping=aes(x = 1.05 * sin(middle), y = 1.05 * cos(middle), label = labels_w_num,hjust=hjust,vjust=vjust),
                  size=3,
...
\begin{figure}[H]
\centering
 \includegraphics[width=0.8\textwidth, trim = {0 1.8cm 0.6cm 0.2cm}]{D:/Users/LDurbak/Box Sync/My Box Notes/HPC/R Factsheets Uninsurance/hpc-uninsurance-factsheets-master/design/fig.pdf}
 \end{figure}
