...
state_table[,grep("_mn",colnames(state_table))]<-format(round(as.numeric(state_table[,grep("_mn",colnames(state_table))]*100), 1),nsmall=1)
...
country_table[,grep("_mn",colnames(country_table))]<-format(round(as.numeric(country_table[,grep("_mn",colnames(country_table))]*100), 1),nsmall=1)
...
In `r state_table$statename`, `r statement1`, the uninsurance rate fell from `r state_table$ui_mn13` percent in 2013 to `r state_table$ui_mn` percent in 2017. Despite these gains, approximately `r statement 7` `r state_table$statename` women of reproductive age remained uninsured in 2017.
