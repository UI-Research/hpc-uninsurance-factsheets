...
In `r state_table$statename`, `r statement1`, the uninsurance rate fell from `r format(state_table$ui_mn13, digits=1, nsmall=1)` percent in 2013 to `r format(state_table$ui_mn, digits=1, nsmall=1)` percent in 2017. Despite these gains, approximately `r statement7` `r statement8` women of reproductive age remained uninsured in 2017.
...
\item Women of reproductive age in `r state_table$statename` had a `r statement2` uninsurance rate (`r format(state_table$ui_mn, digits=1, nsmall=1)` percent) `r statement3` similar women nationwide (11.7 percent) in 2017 (figure 1).
