...
\newcommand{\urbnlogofunderlogo}[0]{
  \begin{figure}
  \centering
  \begin{minipage}{.5\textwidth}
    \centering
    \hspace{-0.12in}  
    \includegraphics[width=1.5in,left,clip,trim = {0 10cm 0 0}]{design/urban_grid_blue_white.jpg}
    \label{fig:test1}
  \end{minipage}%
  % \begin{minipage}{.5\textwidth}
  %   \centering
...
\newcommand{\contactinfo}[0]{
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \draw 
      node[align=center, anchor=south west, minimum height=0.5in, minimum width=8.5in, text width=8in] at ($(current page.south west) + (0in,0.13in)$)
